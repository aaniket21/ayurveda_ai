    ...
    <div className="ba-section">
      ...
      <div className="ba-text-content">
        <h3 className="ba-title">
          <span>Why Choose AyurVeda</span>
        </h3>
        <p className="ba-description">
          Discover the reasons to choose AyurVeda Plus for your healthcare needs.
        ...
        <p className="ba-checks ba-check-first">
          <FontAwesomeIcon icon={faCircleCheck} style={{ color: "#1E8FFD" }} /> Best Professional Vaidyas
        </p>
